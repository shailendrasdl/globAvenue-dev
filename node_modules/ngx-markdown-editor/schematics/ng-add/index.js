...
function registerInPackageJson(_options) {
    return (tree, _context) => {
        ...
        if (tree.exists('package.json')) {
            ...
            const packageInfo = JSON.parse(util_1.readFile(tree, 'package.json'));
            let changed = false;
...
function updateAngularJson(_options) {
    return (tree, _context) => {
        ...
        const workspace = util_1.getWorkspace(tree);
        const project = util_1.getProjectFromWorkspace(workspace, _options.project);
