(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('prosemirror-state'), require('prosemirror-view'), require('prosemirror-commands'), require('prosemirror-schema-list'), require('prosemirror-model'), require('prosemirror-schema-basic')) :
    typeof define === 'function' && define.amd ? define('ngx-editor', ['exports', '@angular/core', '@angular/forms', 'prosemirror-state', 'prosemirror-view', 'prosemirror-commands', 'prosemirror-schema-list', 'prosemirror-model', 'prosemirror-schema-basic'], factory) :
    (global = global || self, factory(global['ngx-editor'] = {}, global.ng.core, global.ng.forms, global.prosemirrorState, global.prosemirrorView, global.prosemirrorCommands, global.prosemirrorSchemaList, global.prosemirrorModel, global.prosemirrorSchemaBasic));
}(this, (function (exports, core, forms, prosemirrorState, prosemirrorView, prosemirrorCommands, prosemirrorSchemaList, prosemirrorModel, prosemirrorSchemaBasic) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MenuItemView = /** @class */ (function () {
        ...
        MenuItemView.prototype.setupCommandListeners = function () {
            ...
            if (this.menuItem.type === 'mark') {
                command = prosemirrorCommands.toggleMark(schema.marks[this.menuItem.key]);
            }
    ...
    var orderedList$1 = Object.assign({}, prosemirrorSchemaList.orderedList, { content: 'list_item+', group: listGroup });
    var bulletList$1 = Object.assign({}, prosemirrorSchemaList.bulletList, { content: 'list_item+', group: listGroup });
    var nodes = Object.assign({}, prosemirrorSchemaBasic.nodes, {
        list_item: listItem,
        ordered_list: orderedList$1,
        bullet_list: bulletList$1
    });
    var marks = prosemirrorSchemaBasic.marks;
